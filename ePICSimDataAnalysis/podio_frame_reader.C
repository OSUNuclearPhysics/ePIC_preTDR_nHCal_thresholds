...
void podio_frame_reader(
    const std::string& root_file_name = "/gpfs/mnt/gpfs02/eic/palsp/simdir/100k/neutron/epic/170_45/neutron_gun_5GeV_170_45_sci_tiles_version2_new_geo_341062_0.edm4hep.root", // input ROOT file
